...
with open('recipe1M_layers/layer1.json', "r") as f, open('recipes.csv', 'w') as csv_file:
    ...
    for record in ijson.items(f, "item"):
        ...
        for ingredient_dict in ingredients_lis:
            ...
            ingredient, final_ingredient = cleanup_ingredient(ingredient)
            ...
            ingredient_str = str(ingredient_num) + '. ' + final_ingredient + ' '
    ...
    with open('ingredient_counts.txt', 'w+') as f:
    ...
    with open('ingredient_len.txt', 'w+') as f:
        ingredient_counter = Counter(ingredient_lis)
